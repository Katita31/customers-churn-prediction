...
- Implementation and comparison of **Decision Tree, Bagging, Random Forest**, and **MLP Neural Network**.  
...
- Simple **Multi-Layer Perceptron** trained with *MLPClassifier* from scikit-learn.  
- Introduces a deep learning perspective and serves as a baseline for ensemble methods.
